...
impl SePolicy {
    pub fn magisk_rules(&mut self) {
        ...
        rules! {
            ...
            allowxperm(["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                      ["domain"], ["tcp_socket", "udp_socket", "rawip_socket"], xall);

            // Let binder work with all specified domains
            allow(svcmgr, ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["dir"], ["search"]);
            allow(svcmgr, ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["file"], ["open", "read", "map"]);
            allow(svcmgr, ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["process"], ["getattr"]);
            allow(["domain"], ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["binder"], ["call", "transfer"]);

            // Other common IPC - 简化版本
            allow(["domain"], ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["process"], all);
            allow(["domain"], ["shell", "platform_app", "untrusted_app_all", "untrusted_app", "priv_app", "system_app", "zygote"], 
                  ["fd"], all);
            ...
            allow(["shell", "platform_app", "system_app", "priv_app", "untrusted_app", "untrusted_app_all", "zygote"],
                [proc], ["unix_stream_socket"], ["connectto", "getopt"]);

            // Let selected domains access tmpfs files
            allow(["init", "zygote", "shell", "platform_app", "system_app", "priv_app", "untrusted_app", "untrusted_app_all"], 
                  ["tmpfs"], ["file"], all);
